...
This paper explores the machine learning method Random Forest. Random Forest is a collection (ensemble of decision trees) and average the outcome for decision. Random Forest is being used in Alzeheimer's research and this paper helps walk through what the methodology is, how it works, and the application with the dataset. 
